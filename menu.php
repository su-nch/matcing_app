...
<head>
    ...
    <style>
        ...
        .swiper-slide {
            ...
            justify-content: center;
            height: 400px;
            background-color: #fff;/*プロフィールの背景 */
    ...
    <i class="fa-solid fa-heart"></i>
        ...
        .like-button:hover:not(:disabled) {
            background-color:rgb(255, 96, 157);
        }*/
    </style>
</head>
<body>
    <header>
        ...
        <nav>
            ...
            <div class="aaa">
                <a href="boy.php" class="boys">男性のおすすめユーザー</a>
            <!-- <div style="display:inline-block; float:senter;"> -->
            <a href="girl.php" class="girls">女性のおすすめユーザー</a></div>
        </nav>
    </header>
